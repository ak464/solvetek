    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-black text-primary">إعدادات الموقع المتقدمة</h1>
                    <p className="text-muted-foreground font-bold mt-1">التحكم الكامل في هوية الموقع، التواصل، والنظام.</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-xl font-black hover:opacity-90 transition shadow-lg shadow-primary/20 disabled:opacity-50"
                >
            ...
            <div className="space-y-8">
                ...
                <div className="bg-card p-8 rounded-[2rem] border border-border shadow-sm relative overflow-hidden group transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                        ...
                        <div className="col-span-2 md:col-span-1">
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">البريد الإلكتروني للدعم</label>
                            <input
                                type="email"
                        ...
                        <div className="col-span-2">
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">وصف الموقع (Meta Description)</label>
                            <textarea
                                value={formData.site_description}
                                onChange={e => setFormData({ ...formData, site_description: e.target.value })}
                                rows={3}
                                className="w-full p-4 bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none"
                                placeholder="وصف قصير يظهر في محركات البحث..."
                            />
                        </div>
                        <div className="col-span-2">
                            <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">الكلمات المفتاحية (Keywords)</label>
                            <input
                                type="text"
                ...
                {/* 2. Social Media */}
                <div className="bg-white dark:bg-gray-900 p-8 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden group transition-colors">
                    ...
                    <div className="flex items-center gap-3 text-purple-600 mb-6 relative z-10 justify-between">
                        <div className="flex items-center gap-3">
                            <Share2 size={24} />
                            <h3 className="text-xl font-black dark:text-white">روابط التواصل الاجتماعي</h3>
                        </div>
                        <label className="flex items-center gap-2 cursor-pointer bg-purple-50 dark:bg-purple-900/20 px-3 py-1 rounded-lg border border-purple-100 dark:border-purple-800 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors">
                    ...
                    <div className="space-y-4 relative z-10">
                        <div className="flex items-center gap-4">
                            ...
                            <input
                                ...
                                className="flex-1 h-12 px-4 bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none"
                ...
                <div className="bg-red-50/50 dark:bg-red-900/10 p-8 rounded-[2rem] border border-red-100 dark:border-red-900/30 shadow-sm relative overflow-hidden transition-colors">
                    <div className="flex items-center gap-3 text-red-600 mb-6 relative z-10">
                        <AlertTriangle size={24} />
                        <h3 className="text-xl font-black dark:text-white">إعدادات النظام (منطقة خطرة)</h3>
                    </div>

                    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-red-100 dark:border-red-800 flex items-center justify-between transition-colors">
                        <div>
                            <h4 className="font-bold text-gray-800 dark:text-white text-lg">وضع الصيانة (Maintenance Mode)</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400 font-bold mt-1">عند تفعيله، سيتم إخفاء الموقع عن جميع الزوار ما عدا المشرفين.</p>
                        </div>
